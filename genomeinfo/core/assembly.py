...
from .chrom import get_chromnames, get_chromsizes, filter_chromosome_data
...
class AssemblyInfo:
    ...
    def __repr__(self):
        return f"AssemblyInfo(assembly={self.assembly}, species={self.species}, common_name={self.common_name})"
